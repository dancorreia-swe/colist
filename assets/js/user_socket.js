...
// And connect to the path in "lib/colist_web/endpoint.ex". We pass the
...
let listSlug = document.location.pathname.split("/").slice(-1)[0];
let todoChannel = socket.channel(`todo:${listSlug}`, {});
